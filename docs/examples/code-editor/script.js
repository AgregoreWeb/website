...
function addURL(url) {
    ...
    const svgHTML = `<svg width="20px" height="20px" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" fill="var(--ag-theme-primary)">
    ...
    copyContainer.style.color = 'var(--ag-theme-primary)';
